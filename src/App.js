...
const App = () => {
  const MAINSLIDRE = [
    ...
    { id: 4, tit: "서류제출", con: "쾌적한 업무 환경을 만들고, 능률적인 업무를 수행하기 위해 반드시 필요한 청소", des: "보양지 제거, 공사먼지 제거, 오염 제거, 시멘트가루 제거 등 구석구석 세밀하게 청소하는 서비스로 가족의 건강을 위해서 입주 전에 꼭 해야 하는 서비스입니다.", link: "/sub05" }
  ]
  ...
  const TOPBG = [
    ...
    {id:5, tit:"카카오뱅크 모바일 대출 / 신용점수 올리기", des:"공동인증서를 통해 서류를 제출해주세요.", src:"/assets/images/sub01_04.png"}
]
