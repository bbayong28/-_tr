...
const App = () => {
  ...
  const TOPBG = [
    {id:0, tit:"일상에서 더 쉽게, 더 자주 이용하는 나만의 은행", des:"카카오뱅크는 사람과 은행의 만남이 더 쉽게, 더 자주 일어나야 한다고 믿습니다.\n사용자 중심의 혁신적인 기술을 통해 일상 속 어떤 순간에서도 유용한 나만의 은행.\n카카오뱅크는 또 하나의 은행이 아닌 '은행의 새로운 시작' 입니다.", src:"/assets/images/sub01_01.png"},
    {id:1, tit:"카카오뱅크 가치 창출 및 지속가능발전목표 이행", des:"카카오뱅크는 UN 지속가능발전목표(Sustainable Development Goals, SDGs)를 지지하며\n경영활동을 통해 창출되는 가치를 통해 목표 이행에 동참하고 있습니다. ", src:"/assets/images/sub01_02.png"},
    {id:2, tit:"언제든지 이용할 수 있는 뱅크", des:"영업점에 방문없이 계좌개설, 대출신청, 해외송금, 증명서 발급까지\n언제든 필요한 은행 업무를 카카오뱅크 모바일앱을 통해 이용해보세요.", src:"/assets/images/sub01_03.png"},
    {id:3, tit:"무엇을 도와드릴까요?", des:"고객님의 금융관련 상담 및 문의사항에 대한\n해결을 위해 최선을 다하겠습니다.", src:"/assets/images/sub01_03.png"}
]
